        ...
        <div className="profile-container">
          <div className="profile-parent">
            <div className="text-section">
              <div className="icons">
                <a
                  href="https://www.linkedin.com/in/muhammad-husnain-shakil-037833249/"
                  target="blank"
                  className="icon"
                >
                  {" "}
                ...
                <a
                  href="https://github.com/Husnain-Shakil"
                  target="blank"
                  className="icon"
                >
                  {" "}
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=100073257401188"
                  target="blank"
                  className="icon"
                >
                  {" "}
                ...
                <a
                  href="https://www.instagram.com/hsnain1020/"
                  target="blank"
                  className="icon"
                >
                  {" "}
              ...
              <h2 className="greetings">
                Hello! I'M <span className="name"> Husnain </span>{" "}
              </h2>

              <ToggleText />

              <p className="knack">
                Knack of building react web apps with modern ui/ux design.
              </p>
              ...
              <div className="buttons">
                ...
                <div className="button1 button2">
                  <a download href={Resume} className="btn1 btn2">
                    Get Resume
                  </a>
                </div>
              </div>
